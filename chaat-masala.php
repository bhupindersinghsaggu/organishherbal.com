        ...
        <div class="row align-items-center ">
            <div class="col-lg-6 mb-1-9 mb-lg-0">
                <div class="position-relative pe-lg-1-9 pe-xl-7 ps-xl-8 text-center about-style01">
                    <img src="theme/img/product/chaat-masala.jpg" class="rounded z-index-1 position-relative" alt="...">
                                    ...
                                    <li>
                                        <div class="text-center text-sm-start d-sm-flex mb-4">
                                            <div class="flex-shrink-0 mb-4 mb-md-0">
                                                <img src="theme/img/product/chaat-masala-round.jpg" class="rounded-circle" alt="...">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            <div class="nutritional-info">
                                                ...
                                                <span class="text-muted font-weight-600">127 kcal</span>
                                            </div>
                                            <div class="nutritional-info">
