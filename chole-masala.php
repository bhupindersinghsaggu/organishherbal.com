                        ...
                        <div class="product-gallery images product-center">
                            <figure class="ttm-product-gallery__wrapper">
                                <div class="product-gallery__image">
                                    <img class="img-fluid" src="images/product/chole-masala.jpg" alt="product-img">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row"> <i
                                            ...
                                            Reduce cholesterol levels </th>
                                    </tr>
                                    <tr>
                                        <th scope="row"> <i
                                                class="fa fa-angle-double-right ttm-textcolor-skincolor"></i>
                                            Lower blood pressure </th>
                                    </tr>
                                    <tr>
                                        <th scope="row"> <i
                                                class="fa fa-angle-double-right ttm-textcolor-skincolor"></i>
                                    ...
                                    <tr>
                                        <th scope="row"> <i
                                                class="fa fa-angle-double-right ttm-textcolor-skincolor"></i>
                                            Helps in dealing with anemia</th>
                                    </tr>
                                </tbody>
                            </table>
