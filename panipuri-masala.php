...
?>
<section class="page-title-section bg-img cover-background" data-overlay-dark="6" data-background="/theme/img/bg/panipuri-masala-bg.jpg" style="background-image: url(_/theme/img/bg/panipuri-masala-bg.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            </div>
        ...
        <div class="row align-items-center ">
            <div class="col-lg-6 mb-1-9 mb-lg-0">
                <div class="position-relative pe-lg-1-9 pe-xl-7 ps-xl-8 text-center about-style01">
                    <img src="theme/img/product/panipuri-masala.jpg" class="rounded z-index-1 position-relative" alt="...">
                    <h5 class="mt-3">AVAILABILITY: 50 g | 100g </h5>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="">
                    <h4 class="display-20 display-sm-15 display-xl-9 mb-3" style="font-size: 35px;">Panipuri Masala
                    </h4>
                    <p>Unique Features and Flavor Profile: What sets Pani Puri Masala apart is its unique combination of spices and herbs. This specially curated blend includes cumin, coriander, black salt, dry mango powder, and other secret ingredients.Gol gappa (also known as pani puri) is a popular bite-size chaat consisting of a hollow, crispy-fried puffed ball that is filled with potato, chickpeas, onions, spices, and flavoured water, usually tamarind or mint, and popped into one's mouth whole. 
                    </p>
                    <div class="col-sm-12">
                                    ...
                                    <li>
                                        <div class="text-center text-sm-start d-sm-flex mb-4">
                                            <div class="flex-shrink-0 mb-4 mb-md-0">
                                                <img src="theme/img/product/jaljeera-masala-round.jpg" class="rounded-circle" alt="...">
                                            </div>
