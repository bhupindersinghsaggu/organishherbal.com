                    ...
                    <div class="ttm-single-product-info clearfix">
                        <div class="product-gallery images product-center">
                            <figure class="ttm-product-gallery__wrapper">
                                <div class="product-gallery__image">
                                    <img class="img-fluid" src="images/product/jaljeera-masala.jpg" alt="product-img">
                        ...
                        <div class="summary entry-summary">
                            ...
                            <div class="product-details__short-description">
                                <p>Jaljeera is a popular welcome drink and the obvious choice for a digestive at any
                                    Indian feast. When combined with ordinary water, a lively blend of seasonings and
                                    condiments that includes mint leaf and dry ginger creates a tangy, sizzling flavour.
                                    It is a popular North Indian drink made with a combination of basic spices like
                                    jeera, pepper, amchur, and Kala Namak. Jaljeera is an Indian spiced, tangy and
                                    savory cooling drink, which is also served as an appetizer.</p>
                            </div>
                            <div class="content-inner active">
                                <h3>About this Item</h3>
                                <ul class="l-height">
                                    <li> Organish herbal Jaljeera is a powder for preparing a glass of tangy refreshing
                                        drink instantly.</li>
                                    <li> Jaljeera powder can also be used in vegetables, meats, gravies and curries top
                                        add a punch of tanginess and sourness.</li>
