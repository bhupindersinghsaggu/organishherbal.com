...
?>
<section class="page-title-section bg-img cover-background" data-overlay-dark="6" data-background="/theme/img/bg/red-powder-bg.jpg" style="background-image: url(_/theme/img/bg/red-powder-bg.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            </div>
...
<section id="moringa">
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="">
                    <h4 class="display-20 display-sm-15 display-xl-9 mb-3" style="font-size: 35px;">Red Chilli Powder
                    </h4>
                    <p>Experience the fiery flavour of our red chilli masala, made with the finest Teja Mirch." Teja
                        Mirch has fiery heat and is considered one of the hottest chillies in India. It is one of the
                        popular chillies. It has a huge demand throughout the world. It grows widely in the Guntur,
                        Prakasam, Warangal and Khammam districts of Andhra Pradesh. The skin of Crusted chilli is thick,
                        red, and hot. It is the great choice for extra hot taste and extra red colour to the Indian
                        Culture.
                    </p>
                    <div class="col-sm-12">
                                        ...
                                        <div class="mb-3">
                                            <div class="nutritional-info">
                                                <ul class="list-style1 mb-0">
                                                    <li>
                                                        <h4 class="h6 mb-0"><i class="ti-check-box text-secondary me-3 font-weight-500"></i>Build
                                                            Immunity & Fights Infections </h4>
                                                    </li>
                                                    <li>
                                                        <h4 class="h6 mb-0"><i class="ti-check-box text-secondary me-3 font-weight-500"></i>Relax
                                                            the body vessels in the body </h4>
                                                    </li>
                                                    <li>
                                                        <h4 class="h6 mb-0"><i class="ti-check-box text-secondary me-3 font-weight-500"></i>Maintain
                                                            Blood Pressure Level </h4>
                                                    </li>
                                                    <li>
                                    ...
                                    <li>
                                        <div class="text-center text-sm-start d-sm-flex mb-4">
                                            <div class="flex-shrink-0 mb-4 mb-md-0">
                                                <img src="theme/img/product/red-round.jpg" class="rounded-circle" alt="...">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            <div class="nutritional-info">
                                                ...
                                                <span class="text-muted font-weight-600">341 kcal</span>
                                            </div>
                                            <div class="nutritional-info">
