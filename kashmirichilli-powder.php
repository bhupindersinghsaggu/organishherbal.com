...
<section id="moringa">
    <div class="container">
        ...
        <div class="row align-items-center ">
            ...
            <div class="col-lg-6">
                <div class="">
                    <h4 class="display-20 display-sm-15 display-xl-9 mb-3" style="font-size: 35px;">Kashmiri Chilli
                        Powder
                    </h4>
                    <p>Vibrant color - our Kashmiri chili has a distinctive red hue which makes it great for grilling
                        meats and dying curries a vibrant red color. Complex citrusy and slightly smoky flavor - This
                        chili isn't just one note but is so complex in its flavor which adds depth to dishes. The chili
                        powder will add a delicious and spicy flavor to your dish, as well as helping to tenderize the
                        meat. Soups and Stews: Kashmiri chili powder can be used to add depth and complexity to soups
                        and stews. Simply add a teaspoon or two of the powder to the pot when you add your other
                        ingredients.
                    </p>
                    <div class="col-sm-12">
                        ...
                        <ul class="list-style2 mb-0">
                            <li>100% natural:- Organish Herbal products are 100% natural and best suitable for your
                                health. </li>
                            <li>Versatile Use: This spice can be used in a wide variety of dishes, including curries, marinades, sauces, grills and tandoori preparations, adding depth of flavour </li>
                            <li>Distinctive flavour: Experience the culinary magic of Kashmiri Red Chilli Powder, where the exceptional taste of Kashmiri chillies will flavor up your taste buds. </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="mb-3">
                                            <div class="nutritional-info">
                                                ...
                                                <span class="text-muted font-weight-600">284 kcal</span>
                                            </div>
                                            <div class="nutritional-info">
