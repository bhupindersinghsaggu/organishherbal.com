        ...
        <div class="row align-items-center ">
            <div class="col-lg-6 mb-1-9 mb-lg-0">
                <div class="position-relative pe-lg-1-9 pe-xl-7 ps-xl-8 text-center about-style01">
                    <img src="theme/img/product/kitchen-king-masala.jpg" class="rounded z-index-1 position-relative" alt="...">
                    <h5 class="mt-3">AVAILABILITY: 50 g | 100g </h5>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="">
                    <h4 class="display-20 display-sm-15 display-xl-9 mb-3" style="font-size: 35px;">Kitchen King Masala
                    </h4>
                    <p>Kitchen King Masala is a versatile spice blend that is typically used to add flavor and aroma to
                        various vegetarian dishes such as curries, vegetables, and lentils. Kitchen king masala is a
                        spice blend necessary for North Indian cookery. This spice mixture is utilized, unlike garam
                        masala, even though it contains many of the same spices. Kitchen King Masala is added to the
                        curry while it is being cooked. In contrast, conventional Garam Masala is sprinkled on top of
                        the curry once cooked.
                    </p>
                    <div class="col-sm-12">
                                                ...
                                                <ul class="list-style1 mb-0">
                                                    <li>
                                                        <h4 class="h6 mb-0"><i class="ti-check-box text-secondary me-3 font-weight-500"></i>
                                                            Prevent arthritis </h4>
                                                    </li>
                                                    <li>
                                                        <h4 class="h6 mb-0"><i class="ti-check-box text-secondary me-3 font-weight-500"></i>Promote
                                                            digestion and gut health </h4>
                                                    </li>
                                                    <li>
                                                        <h4 class="h6 mb-0"><i class="ti-check-box text-secondary me-3 font-weight-500"></i>Prevent
                                                            diabetes </h4>
                                                    </li>
                                                    <li>
                                                        <h4 class="h6 mb-0"><i class="ti-check-box text-secondary me-3 font-weight-500"></i>Helps
                                                            in premenstrual cramps </h4>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <li>
                                        <div class="text-center text-sm-start d-sm-flex mb-4">
                                            <div class="flex-shrink-0 mb-4 mb-md-0">
                                                <img src="theme/img/product/chiken-round.jpg" class="rounded-circle" alt="...">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            <div class="nutritional-info">
                                                ...
                                                <span class="text-muted font-weight-600">415 kcal</span>
                                            </div>
                                            <div class="nutritional-info">
