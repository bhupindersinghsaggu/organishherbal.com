                        ...
                        <div class="product-gallery images product-center">
                            <figure class="ttm-product-gallery__wrapper">
                                <div class="product-gallery__image">
                                    <img class="img-fluid" src="images/product/kitchen-king-masala.jpg"
                                        alt="product-img">
                        ...
                        <div class="summary entry-summary">
                            <p class="price mb-25">
                                <span class="Price-amount amount">
                                    <h2>Kitchen King Masala
                                    </h2>
                                </span>
                            </p>
                            <div class="product-details__short-description">
                                <p>Kitchen King Masala is a versatile spice blend that is typically used to add flavor
                                    and aroma to various vegetarian dishes such as curries, vegetables, and lentils.
                                    Kitchen king masala is a spice blend necessary for North Indian cookery. This spice
                                    mixture is utilized, unlike garam masala, even though it contains many of the same
                                    spices. Kitchen King Masala is added to the curry while it is being cooked. In
                                    contrast, conventional Garam Masala is sprinkled on top of the curry once cooked</p>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row"> <i
                                            ...
                                            Prevent arthritis </th>
                                    </tr>
                                    <tr>
                                        <th scope="row"> <i
                                                class="fa fa-angle-double-right ttm-textcolor-skincolor"></i>
                                            Promote digestion and gut health </th>
                                    </tr>
                                    <tr>
                                        <th scope="row"> <i
                                                class="fa fa-angle-double-right ttm-textcolor-skincolor"></i>
                                    ...
                                    <tr>
                                        <th scope="row"> <i
                                                class="fa fa-angle-double-right ttm-textcolor-skincolor"></i>
                                            Helps in premenstrual cramps</th>
                                    </tr>
                                </tbody>
                            </table>
