                                        ...
                                        <div class="mb-3">
                                            <div class="nutritional-info">
                                                <ul class="list-style1 mb-0">
                                                    ...
                                                    <li>
                                                        <h4 class="h6 mb-0"><i class="ti-check-box text-secondary me-3 font-weight-500"></i>Gives
                                                    ...
                                                    <li>
                                                        <h4 class="h6 mb-0"><i class="ti-check-box text-secondary me-3 font-weight-500"></i>Treats
                                                            Diabetes </h4>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <li>
                                        <div class="text-center text-sm-start d-sm-flex mb-4">
                                            <div class="flex-shrink-0 mb-4 mb-md-0">
                                                <img src="theme/img/product/turmeric-round.jpg" class="rounded-circle" alt="...">
                                            </div>
