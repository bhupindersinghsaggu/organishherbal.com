...
<section class="page-title-section bg-img cover-background" data-overlay-dark="6"
    data-background="/theme/img/bg/turmeric.jpg" style="background-image: url(_/theme/img/bg/turmeric.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            </div>
        ...
        <div class="row align-items-center pdt-100">
            ...
            <div class="col-lg-6">
                <div class="">
                    ...
                    <p>Indulge in the golden richness of our Haldi, sourced from the sun-kissed fields of Andhra Pradesh
                        and the lush landscapes of Tamil Nadu. Our Turmeric is meticulously cultivated and harvested in
                        these regions renowned for their premium quality spices. With every pinch of our Haldi, Savor
                        the authentic flavours and vibrant hues that capture the essence of South Asia cuisine. Elevate
                        your culinary adventures with
                        our Haldi sourced from these fertile lands, where traditionmeets excellence.
                    </p>
                    <div class="col-sm-12">
                                        ...
                                        <div class="mb-3">
                                            <div class="nutritional-info">
                                                <ul class="list-style1 mb-0">
                                                    <li>
                                                        <h4 class="h6 mb-0"><i
                                                                class="ti-check-box text-secondary me-3 font-weight-500"></i>Prevent
                                                            cancer growth cells </h4>
                                                    </li>
                                                    <li>
                                                        <h4 class="h6 mb-0"><i
                                                                class="ti-check-box text-secondary me-3 font-weight-500"></i>Gives
                                                            you a glowing skin </h4>
                                                    </li>
                                                    <li>
                                                        <h4 class="h6 mb-0"><i
                                                                class="ti-check-box text-secondary me-3 font-weight-500"></i>Prevents
                                                            Inflammation </h4>
                                                    </li>
                                                    <li>
                                                        <h4 class="h6 mb-0"><i
                                                                class="ti-check-box text-secondary me-3 font-weight-500"></i>Treats
                                                            Diabetes </h4>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <li>
                                        <div class="text-center text-sm-start d-sm-flex mb-4">
                                            <div class="flex-shrink-0 mb-4 mb-md-0">
                                                <img src="theme/img/product/turmeric-round.jpg" class="rounded-circle"
                                                    alt="...">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            <div class="nutritional-info">
                                                ...
                                                <span class="text-muted font-weight-600">35 kcal</span>
                                            </div>
                                            <div class="nutritional-info">
